...
// {
// private:
//     vector<Brush> m_brush = {Brush(), Brush(), Brush()};
...
// g++ - o main main.cpp classVelocity.cpp classSensor.cpp classRoller.cpp classBrush.cpp classBrush.hpp classRoller.hpp classSensor.hpp classVelocity.hpp